...
<li class="tickets-list__item js-card">
    <div class="ticket-card ticket-card--color<?php echo sprintf(
        ...
        <div class="ticket-card__img">
            ...
            srcset="<?= Html::encode($model->picture);?>@2x.jpg 2x" alt="Изображение 
        ...
        <div class="ticket-card__info">
            ...
            <div class="ticket-card__header">
                <h3 class="ticket-card__title">
                    ...
                    <a href="<?= Url::to(['/offers/edit', 'id' => $model->id]); ?>">
                        <?= Html::encode($model->title);?>
                    </a>
                    <?php endif; ?>
                ...
                <p class="ticket-card__price"><span class="js-sum">
                    <?= Html::encode(Yii::$app->formatter->asDecimal($model->price)); ?></span> ₽
                </p>
            </div>
        </div>
